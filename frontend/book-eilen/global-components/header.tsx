...
import { ArrowPathIcon, Bars3Icon, ChartPieIcon, CursorArrowRaysIcon, FingerPrintIcon, SquaresPlusIcon } from '@heroicons/react/24/outline';
                ...
                <div className="be-navbar-content">
                    ...
                    <div className="be-logo">
                        <a href="#" className="be-link">
                            ...
                            <Image alt="Logo-Image" src={LogoImage} width="158" height="38" className="" />
                        </a>
                    </div>
                    {/* nav-list-dropdown */}
                    ...
                    <PopoverGroup className="be-profile-dropdown">
                        <Popover className="be-dropdown">
                            ...
                            <PopoverPanel transition className="be-dropdown-content">
                                <div className="p-4 be-list-content">
                                    <h5>
                                        <Image alt="person-icon" src={PersonIcon} width="26" height="26" className="person-icon" /> My
                                        Profile
                                    </h5>
                                    <div className="be-list">
                                        <ul>
