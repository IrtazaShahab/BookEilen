   ...
   <footer className="be-footer">
    <div className="footer-content">
        <div className="be-footer-top">
          ...
          <div className="be-top-right-content">
              <div>
                  ...
                  <ul className="">
                      <li className="">
                          <a href="#" className="">Genre</a>
                      </li>
                      <li>
                          <a href="#" className="">About Us</a>
                      </li>
                      <li className="">
                          <a href="#" className="">Our Bookstore</a>
                      </li>
                      <li className="">
                          <a href="#" className="">Shipping & Delivery</a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul className="">
                      ...
                      <li>
                          <a href="https://discord.gg/4eeurUVvTy" className="">X</a>
                      </li>
                      <li>
                          <a href="https://discord.gg/4eeurUVvTy" className="">Instagram</a>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div className="be-footer-bottom">
          <span className="">© 2025 . All Rights Reserved.
          </span>
      </div>
    </div>
   </footer>
